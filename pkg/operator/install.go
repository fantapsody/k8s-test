...
const zookeeperCatalogSrcName = "pulsar-manifests"

//const zookeeperManifestsImageName = "gcr.io/affable-ray-226821/streamnative/operator-index/pulsar-manifests:latest"
